...
export const Footer = () => {
  ...
  return (
    <footer className="flex flex-col gap-[50px]  bottom-0 w-full py-[50px]">
      <div className="-bg-blue -text-white  font-medium flex flex-col items-center py-[50px] md:py-[50px] gap-[30px] px-5 text-center md:text-start md:flex-row justify-between lg:justify-around lg:gap-[200px] md:px-10 lg:px-0">
        <p className="text-[1.5rem] md:text-[1.6rem] md:w-[50%] lg:text-[2rem] lg:w-[30%]">
      ...
      <div className="text-[18px] flex flex-col md:flex-row justify-around gap-[30px] px-6 md:px-10">
        <div className="w-[50%] md:w-[20%] md:text-[16px]">
          <h3 className="text-[30px] md:text-[1.5rem] font-medium lg:text-[1.2rem]">
            WearHouse
          </h3>
          <p className="lg:text-[15px] ">Your trusted fashion companion</p>
        </div>
        <div className="flex flex-col gap-1 lg:text-[16px] md:text-[16px]">
          <h3 className="text-[24px] font-medium md:text-[1.5rem] lg:text-[1.2rem]">
            NAVIGATION
          </h3>
          <Link to={"/"}>Home</Link>
          <Link>Shop</Link>
        ...
        <div className="text-[35px] flex gap-[10px] md:text-[2rem] lg:text-[20px]">
          <a

...
export const ButtonWhite = ({ text, className, icon, onClick }) => {
  return (
    <button
      onClick={onClick}
      className={`${className} group w-fit px-[50px] py-[12px] text-[20px] lg:px-[5rem] lg:py-[1.4rem] font-semibold -text-black -bg-white hover:-bg-blue transition-all duration-500 ease-in-out hover:-text-white flex items-center gap-2`}
    >
